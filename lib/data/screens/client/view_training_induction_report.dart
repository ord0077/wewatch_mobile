...
import 'package:wewatchapp/data/models/view_Training_Induction_Model.dart';
...
class view_training_induction_report extends StatefulWidget {
  view_training_induction_report({Key key,}) : super(key: key);

  @override
  _view_training_induction_report createState() => _view_training_induction_report();
}

class _view_training_induction_report extends State<view_training_induction_report> {
...
//      ),
  ...
  Future<ViewTrainingInductionModel> sendPagesDataRequest(int page) async {
...
"data": [
 ...
 "next_page_url": "https:/API_URL?page=2"
      ...
      ViewTrainingInductionModel viewTrainingInductionModel = viewTrainingInductionModelFromMap(response.body);
      return viewTrainingInductionModel;
    } catch (e) {
      if (e is IOException) {
  ...
  List<dynamic> listItemsGetter(ViewTrainingInductionModel viewTrainingInductionModel) {
    List<Datum> list = [];
    viewTrainingInductionModel.data.forEach((value) {
      list.add(value);
    });
    return list;
  }
...
//                 width: MediaQuery.of(context).size.width ,
                                  ...
                                  children: <Widget>[
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text("Session Type",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 15.0),),
                                      ),
                                  ...
                                  children: <Widget>[
                                    Align(
                                      ...
                                      child:  Container(
                                        ...
                                        child:Text( Datum.sessionType ??"----" ,style: TextStyle(fontSize: 15.0)),
                                      ),
                                    ),
                                  ...
                                  children: <Widget>[
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text("Training / Toolbox Talk Subject",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 15.0),),
                                      ),
                                  ...
                                  children: <Widget>[
                                    Align(
                                      ...
                                      child:  Container(
                                        ...
                                        child:Text( Datum.subject ??"----",style: TextStyle(fontSize: 15.0)),
                                      ),
                                    ),
                                  ...
                                  children: <Widget>[
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text("Number of Attendees",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 15.0),),
                                      ),
                                  ...
                                  children: <Widget>[
                                    Align(
                                      ...
                                      child:  Container(
                                        ...
                                        child:Text( Datum.noAttendees.toString() ??"----",style: TextStyle(fontSize: 15.0)),
                                      ),
                                    ),
  ...
  Widget errorWidgetMaker(ViewTrainingInductionModel viewTrainingInductionModel, retryListener) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
        Padding(
  ...
  Widget emptyListWidgetMaker(ViewTrainingInductionModel viewTrainingInductionModel) {
    return Center(
      child: Text('No records in the list !',style: TextStyle(fontSize: 15.0)),
    );
  }

  int totalPagesGetter(ViewTrainingInductionModel viewTrainingInductionModel) {
    return viewTrainingInductionModel.total;
  }

  bool pageErrorChecker(ViewTrainingInductionModel viewTrainingInductionModel) {
