...
import 'package:wewatchapp/data/models/view_Observation_Model.dart';
...
class view_observation_report extends StatefulWidget {
  view_observation_report({Key key,}) : super(key: key);

  @override
  _view_observation_report createState() => _view_observation_report();
}

class _view_observation_report extends State<view_observation_report> {
...
//      ),
  ...
  Future<ViewObservationModel> sendPagesDataRequest(int page) async {
...
"data": [
 ...
 "next_page_url": "https:/API_URL?page=2"
      ...
      ViewObservationModel viewObservationModel = viewObservationModelFromMap(response.body);
      return viewObservationModel;
    } catch (e) {
      if (e is IOException) {
  ...
  List<dynamic> listItemsGetter(ViewObservationModel viewObservationModel) {
    List<Datum> list = [];
    viewObservationModel.data.forEach((value) {
      list.add(value);
    });
    return list;
  }
...
//                 width: MediaQuery.of(context).size.width ,
                                  ...
                                  children: <Widget>[
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text("Description",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 15.0),),
                                      ),
                                  ...
                                  children: <Widget>[
                                    Align(
                                      ...
                                      child:  Container(
                                        ...
                                        child:Text( Datum.observationDescription ??"----",style: TextStyle(fontSize: 15.0)),
                                      ),
                                    ),
                                  ...
                                  children: <Widget>[
                                    Align(
                                      ...
                                      child:  Container(
                                        ...
                                        child:Text( Datum.action ??"----",style: TextStyle(fontSize: 15.0)),
                                      ),
                                    ),
                                  ...
                                  children: <Widget>[
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text("Report Type",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 15.0),),
                                      ),
                                  ...
                                  children: <Widget>[
                                    Align(
                                      ...
                                      child:  Container(
                                        ...
                                        child:Text( Datum.report ??"----",style: TextStyle(fontSize: 15.0)),
                                      ),
                                    ),
  ...
  Widget errorWidgetMaker(ViewObservationModel viewObservationModel, retryListener) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
        Padding(
  ...
  Widget emptyListWidgetMaker(ViewObservationModel viewObservationModel) {
    return Center(
      child: Text('No records in the list !',style: TextStyle(fontSize: 15.0)),
    );
  }

  int totalPagesGetter(ViewObservationModel viewObservationModel) {
    return viewObservationModel.total;
  }

  bool pageErrorChecker(ViewObservationModel viewObservationModel) {
