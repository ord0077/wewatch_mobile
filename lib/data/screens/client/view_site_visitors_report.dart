...
import 'package:wewatchapp/data/models/view_Site_Visitors_Model.dart';
...
class view_site_visitors_report extends StatefulWidget {
  view_site_visitors_report({Key key,}) : super(key: key);

  @override
  _view_site_visitors_report createState() => _view_site_visitors_report();
}

class _view_site_visitors_report extends State<view_site_visitors_report> {
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child:Text('Site Visitors Report',
...
//      ),
  ...
  Future<ViewSiteVisitorsModel> sendPagesDataRequest(int page) async {
...
//    final apiUrl = 'https://orangeroomdigital.com/sscp/public/api/btl_records';
    String apiUrl = Uri.encodeFull("https://wewatch.ordd.tk/api/dailyvisitorsregister/project/" + progId.toString() +"?page=$page");
    print('page ${page}');
    try {
...
"data": [
 ...
 "next_page_url": "https:/API_URL?page=2"
      ...
      ViewSiteVisitorsModel viewSiteVisitorsModel = viewSiteVisitorsModelFromMap(response.body);
      return viewSiteVisitorsModel;
    } catch (e) {
      if (e is IOException) {
  ...
  List<dynamic> listItemsGetter(ViewSiteVisitorsModel viewSiteVisitorsModel) {
    List<Datum> list = [];
    viewSiteVisitorsModel.data.forEach((value) {
      list.add(value);
    });
    return list;
  }
...
//                 width: MediaQuery.of(context).size.width ,
                                  ...
                                  children: <Widget>[
                                    Align(
                                      ...
                                      child:  Container(
                                        ...
                                        child:Text( Datum.companyName ??"----" ,style: TextStyle(fontSize: 15.0)),
                                      ),
                                    ),
                                  ...
                                  children: <Widget>[
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text("Driver Contact # ",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 15.0),),
                                      ),
                                  ...
                                  children: <Widget>[
                                    Align(
                                      ...
                                      child:  Container(
                                        ...
                                        child:Text( Datum.driverContact ??"----",style: TextStyle(fontSize: 15.0)),
                                      ),
                                    ),
                                  ...
                                  children: <Widget>[
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text("Reason For Visit",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 15.0),),
                                      ),
                                  ...
                                  children: <Widget>[
                                    Align(
                                      ...
                                      child:  Container(
                                        ...
                                        child:Text( Datum.visitReason ??"----",style: TextStyle(fontSize: 15.0)),
                                      ),
                                    ),
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text("ID Attachment",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 15.0),),
                                    ),
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text("Car Attachment",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 15.0),),
                                    ),
  ...
  Widget errorWidgetMaker(ViewSiteVisitorsModel viewSiteVisitorsModel, retryListener) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
        Padding(
  ...
  Widget emptyListWidgetMaker(ViewSiteVisitorsModel viewSiteVisitorsModel) {
    return Center(
      child: Text('No records in the list !',style: TextStyle(fontSize: 15.0)),
    );
  }

  int totalPagesGetter(ViewSiteVisitorsModel viewSiteVisitorsModel) {
    return viewSiteVisitorsModel.total;
  }

  bool pageErrorChecker(ViewSiteVisitorsModel viewSiteVisitorsModel) {
